...
# 2. Agents (skills)
# ============================================================
echo -e "${GREEN}[2/6] Installation des 5 agents...${NC}"

mkdir -p "$TARGET/.claude/commands"

AGENTS=("stratege" "code-dev" "testeur" "devops" "designer")
...
echo -e "  Agents     : .claude/commands/ (5 skills)"
...
echo ""
echo -e "  3. Lancer les 6 agents dans 6 terminaux Claude Code :"
echo ""
echo -e "     ${GREEN}Terminal 1 :${NC} /loop 600 /stratege"
echo -e "     ${GREEN}Terminal 2 :${NC} /loop 600 /code-dev     ${YELLOW}# instance 1${NC}"
echo -e "     ${GREEN}Terminal 3 :${NC} /loop 600 /code-dev     ${YELLOW}# instance 2${NC}"
echo -e "     ${GREEN}Terminal 4 :${NC} /loop 600 /testeur"
echo -e "     ${GREEN}Terminal 5 :${NC} /loop 600 /devops"
echo -e "     ${GREEN}Terminal 6 :${NC} /loop 600 /designer"
echo ""
echo -e "  ${PURPLE}Tu peux ajouter plus de code-dev : chaque instance${NC}"
echo -e "  ${PURPLE}utilise un lock atomique, pas de limite.${NC}"
echo ""
